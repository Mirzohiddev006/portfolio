...
const experiences: ExperienceItem[] = [
  {
    ...
    endDate: "Present",
    description:
      "Developed a comprehensive Club Information Management System (CIMS) with real-time dashboards, player management, and staff coordination features. Implemented JWT authentication and role-based access control.",
    technologies: [
      "React",
      "JavaScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    endDate: "Present",
    description:
      "Delivered custom web solutions for various clients, including e-commerce platforms, landing pages, and business dashboards. Focused on responsive design and performance optimization.",
  ...
  },
  {
    ...
    endDate: "Present",
    description:
      "Led development of multiple academic projects including statistical analysis tools, data visualization dashboards, and econometric modeling applications.",
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 flex-col items-center">
        ...
        >
          <div
            className="w-4 h-4 bg-[#0a0a0a] border-2 border-[#00ff41] rounded-full"
      ...
      >
        <motion.div
          ...
          className="bg-[#0a0a0a]/70 backdrop-blur-lg border border-[#00ff41]/10 p-4 sm:p-5 md:p-6 rounded-xl hover:border-[#00ff41]/30 hover:shadow-[0_0_20px_rgba(0,255,65,0.2)] transition-all duration-300"
        >
          {/* Mobile timeline dot */}
          <div className="flex md:hidden items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <div
              className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-[#00ff41] rounded-full"
              style={{ boxShadow: "0 0 10px #00ff41" }}
            />
          ...
          <div
            className={`hidden md:block font-mono text-xs sm:text-sm text-[#00ff41] mb-2 ${
          ...
          <h3
            className={`font-display text-lg sm:text-xl text-white mb-1 ${
              index % 2 === 0 ? "md:text-right" : ""
            }`}
          >
            {experience.position}
          ...
          <p
            className={`font-mono text-[10px] xs:text-xs text-gray-500 mb-3 sm:mb-4 ${
              index % 2 === 0 ? "md:text-right" : ""
            }`}
          >
            📍 {experience.location}
          ...
          <p
            className={`font-body text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4 ${
              index % 2 === 0 ? "md:text-right" : ""
            }`}
          >
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        {/* Timeline */}
        <div className="relative space-y-8 sm:space-y-10 md:space-y-12 md:space-y-0">
